function [var1,var2,tv_dt] = compareVarsDiffSites(path,site,year,indVar1,indVar2,plotName)
...
pthOut1 = fullfile(path,'yyyy',site,dataType1);
pthOut2 = fullfile(path,'yyyy',site,dataType2);
